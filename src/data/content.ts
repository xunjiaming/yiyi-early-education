...
const LANG_0_6: Record<string, DayItem[]> = {
  ...
  '4-6m': [
    ...
    { id: 'lang2', title: '喂奶旁白', how: '喂奶时轻声说：“之之在喝奶啦，香香的，慢慢喝。”', note: '旁边白、轻声，不急不赶。' },
    ...
    { id: 'lang8', title: '睡前轻声对话', how: '睡前轻声说：“之之今天玩得很开心，天黑了，该睡觉啦，晚安。”', note: '语速放慢，语调温柔。' }
  ]
}
...
const COG_0_6: Record<string, DayItem[]> = {
  ...
  '4-6m': [
    ...
    { id: 'cog3', title: '照镜子互动', how: '抱着宝宝照镜子，指着镜里的人说：“这是之之，这是妈妈。”', note: '让宝宝自己看和伸手碰。' },
